...
if __name__ == '__main__':
    ...
    with open("result.txt", "w") as writer:
        ...
        try:
            msg_uhpp_electricity_power_plant = \
                'Maximum Head for UHPP happens when Upper Reservoir in its maximum ' \
            ...
            result7 = f"\n*** Solution 8 ***\n{msg_uhpp_electricity_power_plant}, " \
                      f"{start_time_max} - {end_time_max} o`clock"
        ...
        try:
            msg_max_height_upper_alpha = \
                'Minimum Head for UHPP happens when Upper Reservoir in its minimum level AND ' \
        ...
        try:
            ...
            msg_lhpp_electricity_power_plant = \
                'Between the start of May and the end of August, Lake Alpha Volume goes from ' \
